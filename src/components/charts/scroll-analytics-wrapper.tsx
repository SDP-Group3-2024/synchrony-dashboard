...
const ScrollAnalyticsWrapper: React.FC<ScrollAnalyticsWrapperProps> = ({
  initialData,
}) => {
  ...
  const uniquePages = initialData && initialData.length > 0
            ...
            {showDatePicker && (
              <div className="absolute z-10 mt-1 bg-background border rounded-md shadow-lg">
                ...
                <div className="p-2 border-t flex justify-end gap-2">
                  ...
                  <Button size="sm" onClick={fetchFilteredData}>
                    Apply
                  </Button>
                </div>
              </div>
